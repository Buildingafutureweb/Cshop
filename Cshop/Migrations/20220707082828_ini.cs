    ...
    public partial class ini : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Welcome to Warehouse!", "Warehouse", "/pic/shops/shop1.jpg" });

            migrationBuilder.InsertData(
                table: "Shops",
                columns: new[] { "ShopId", "ShopDesciption", "ShopName", "ShopPicture" },
                values: new object[] { 2, "Welcome to Countdown Invercargill store!", "Countdown", "/pic/shops/shop2.png" });

            migrationBuilder.InsertData(
                table: "Shops",
                columns: new[] { "ShopId", "ShopDesciption", "ShopName", "ShopPicture" },
                values: new object[] { 3, "Welcome to Pak n Save Invercargill store!", "PaknSave", "/pic/shops/shop3.jpg" });

            migrationBuilder.InsertData(
                table: "Shops",
                columns: new[] { "ShopId", "ShopDesciption", "ShopName", "ShopPicture" },
                values: new object[] { 4, "Welcome to New World Invercargill store!!", "New World", "/pic/shops/shop4.png" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Description", "Detail", "Picture", "Price", "ProductName", "ShopId", "Sn" },
                values: new object[] { 1, 1, "Fruit and veges that deserve to be tasted, not wasted, the odd bunch have their own unique shapes and looks and therefore each pack will be completely different.", null, "/pic/cases/carrot.jpg", 300m, "Fresh Produce The Odd Bunch Carrots", 11, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Description", "Detail", "Picture", "Price", "ProductName", "ShopId", "Sn" },
                values: new object[] { 2, 1, "Extra sweet and juicy super sweet cobs. A natural source of folate and high in dietary fibre.", null, "/pic/cases/corn.jpg", 12m, "Wattie's Corn Cobs", 11, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Description", "Detail", "Picture", "Price", "ProductName", "ShopId", "Sn" },
                values: new object[] { 3, 1, "A bulb of garlic weighs approx. 70gms.The most common varieties of garlic contain 10 cloves (or segments) with white skin. As a rule, the smaller the clove the stronger the taste!.Garlic can be eaten raw or cooked. Raw garlic gives a strong pungent flavour, while cooking gives a more mellow flavour.Garlic burns easily , so take care when frying or sauteing.It can be used in vegetable and meat dishes, soups, dips, stir fries, braises and stews, or add whole unpeeled cloves into a roasting pan with meat or vegetables.", null, "/pic/cases/garlic.jpg", 5m, "Fresh Produce Garlic", 1, null });
